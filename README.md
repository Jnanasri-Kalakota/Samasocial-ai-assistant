...
3. Copy the required configuration values
4. Configure the local Ollama connection and other application settings
5. Start the backend
```
...
Only `.env.example` should be committed to the public repository.
...
Make sure the required models are available locally before starting the application.
...
Start the frontend using the development command configured in `package.json`.
...
- SQLite for local zero-configuration persistence
- PostgreSQL / Supabase with pgvector readiness

---

# Project Goals

The goal of SamaSocial AI was not to build another generic chatbot.

The project focuses on building an **evidence-first learning assistant** where:

1. Users provide their own learning material.
2. The application understands and indexes that material.
3. Questions are answered using retrieved evidence.
4. Citations preserve the origin of the information.
5. Users can test their understanding through quizzes.
6. Users can generate structured learning plans through the course-planning assistant.
...
- Tests
- Task 1 Learning Assistant
- Task 2 Course Planning Assistant foundation
- Environment configuration template
- Project documentation

### Demo

A 3–5 minute demo video demonstrates the application working end-to-end, including:

- Multi-source ingestion
- Grounded question answering
- Evidence citations
- YouTube timestamp provenance
- Quiz generation
...
A public deployment is not provided because the submitted configuration uses local Ollama inference running on the development machine.
